...
table_name = loan_to == "P"
    ...
    if (!(show_loan_dtls.suc === 1 && show_loan_dtls.msg.length > 0)) {
      ...
      mem_order = `a.group_code,c.group_name,a.member_code desc`
