...
groupRecoveryRouter.post("/fetch_loan_details", async (req, res) => {
    ...
    let mem_select = "a.loan_id AS mem_loan_id,a.group_code,c.group_name,a.member_code AS member_id,d.member_name,COALESCE(a.prn_amt,0) AS principal_amt,d.member_account_no AS sb_acc_no,SUM(COALESCE(e.cr_amt,0)) AS cr_amt,SUM(COALESCE(e.sb_amt,0)) AS sb_amt,e.approval_status",
      ...
      mem_whr = `a.tenant_id = '${tenant_id}' AND a.ccb_loan_id = '${loan.loan_id}' AND a.group_code = '${group_code}' GROUP BY a.loan_id,a.group_code,c.group_name,a.member_code,d.member_name,a.prn_amt,d.member_account_no`;
