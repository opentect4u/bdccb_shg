...
ppRouter = express.Router();
    ...
    ppRouter.post("/save_post", async (req, res) => {
        try {
            ...
            const values = po_id > 0 ? [dist_id, block_id, post_name, pin, created_by, created_at, created_ip] : [dist_id, block_id, post_name, pin, 'N', created_by, created_at, created_ip];
    ...
    ppRouter.post("/save_policestation", async (req, res) => {
        try {
            ...
            const values = ps_id > 0 ? [dist_id, block_id, ps_name, created_by, created_at, created_ip] : [dist_id, block_id, ps_name, 'N', created_by, created_at, created_ip];
