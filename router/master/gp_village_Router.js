...
gpvillRouter = express.Router();
    ...
    gpvillRouter.post("/save_branch", async (req, res) => {
        try {
            ...
            var branch_juri_id = branch_jurisdiction_id || 0;
            const table = "md_branch";
            const columns = branch_id > 0 ? ["dist_id","tenant_id","block_id","branch_type","branch_name","branch_address","pin_no","contact_person","branch_phone","modified_by","modified_at","closed_opened_by","closed_opened_at","ip_address","branch_jurisdiction_id"] : ["dist_id","tenant_id","block_id","branch_type","branch_name","branch_address","pin_no","contact_person","branch_phone","created_by","created_at","closed_opened_by","closed_opened_at","ip_address","branch_jurisdiction_id"];
            const values = branch_id > 0 ? [dist_id, tenant_id, block_id, branch_type, branch_name, branch_address, pin_no, contact_person, branch_phone, created_by, new Date(),closed_opened_by,closed_opened_at, created_ip, branch_juri_id] : [dist_id, tenant_id, block_id, branch_type, branch_name, branch_address, pin_no, contact_person, branch_phone, created_by, new Date(),closed_opened_by,closed_opened_at, created_ip, branch_juri_id];
