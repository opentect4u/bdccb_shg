...
groupRouter.post("/fetch_group_details", async (req, res) => {
  ...
  OR a.group_code::text ILIKE '%${data.group_name}%')`
    ...
    var select = "a.group_code,a.branch_code,b.branch_name,a.group_name,a.phone1,a.sahayika_id,d.sahayika_name,a.group_addr,a.dist_id,e.dist_name,a.block_id,f.block_name,a.ps_id,g.ps_name,a.po_id,h.post_name,a.gp_id,i.gp_name,a.village_id,j.vill_name,a.pin_no,a.open_close_flag,a.grp_open_dt,a.grp_close_dt,a.delete_flag,a.direct_indirect_flag,a.pacs_id,k.branch_name AS pacs_name",
      table_name = "bdccb.md_group a LEFT JOIN public.md_branch b ON TRIM(a.branch_code::text) = TRIM(b.branch_id::text) LEFT JOIN bdccb.md_sahayika d ON TRIM(a.sahayika_id::text) = TRIM(d.sahayika_id::text) LEFT JOIN public.md_district e ON TRIM(a.dist_id::text) = TRIM(e.dist_code::text) LEFT JOIN public.md_block f ON TRIM(a.block_id::text) = TRIM(f.block_id::text) LEFT JOIN public.md_police_station g ON TRIM(a.ps_id::text) = TRIM(g.ps_id::text) LEFT JOIN public.md_postoffice h ON TRIM(a.po_id::text) = TRIM(h.po_id::text) LEFT JOIN public.md_gp i ON TRIM(a.gp_id::text) = TRIM(i.gp_id::text) LEFT JOIN public.md_village j ON TRIM(a.village_id::text) = TRIM(j.vill_id::text) LEFT JOIN public.md_branch k ON TRIM(a.pacs_id::text) = TRIM(k.branch_id::text)",
...
groupRouter.get("/fetch_grp_dtls_code", async (req, res) => {
  try {
    ...
    var select = "a.group_code,a.branch_code,a.group_name,a.phone1,a.sahayika_id,a.group_addr,b.branch_name,d.sahayika_name,e.dist_name,f.block_name,g.ps_name,h.post_name,i.gp_name,j.vill_name,a.dist_id,a.block_id,a.ps_id,a.po_id,a.gp_id,a.village_id,a.pin_no,a.sb_ac_no,a.direct_indirect_flag,a.pacs_id,a.economic_activity",
      table_name = "bdccb.md_group a LEFT JOIN public.md_branch b ON TRIM(a.branch_code::text) = TRIM(b.branch_id::text) LEFT JOIN bdccb.md_sahayika d ON TRIM(a.sahayika_id::text) = TRIM(d.sahayika_id::text) LEFT JOIN public.md_district e ON TRIM(a.dist_id::text) = TRIM(e.dist_code::text) LEFT JOIN public.md_block f ON TRIM(a.block_id::text) = TRIM(f.block_id::text) LEFT JOIN public.md_police_station g ON TRIM(a.ps_id::text) = TRIM(g.ps_id::text) LEFT JOIN public.md_postoffice h ON TRIM(a.po_id::text) = TRIM(h.po_id::text) LEFT JOIN public.md_gp i ON TRIM(a.gp_id::text) = TRIM(i.gp_id::text) LEFT JOIN public.md_village j ON TRIM(a.village_id::text) = TRIM(j.vill_id::text)",
...
groupRouter.get("/fetch_member_dtls", async (req, res) => {
  try {
    ...
    var select1 = "a.group_code,a.branch_code,a.group_name,a.phone1,a.sahayika_id,a.group_addr,b.branch_name,d.sahayika_name,e.dist_name,f.block_name,g.ps_name,h.post_name,i.gp_name,j.vill_name,a.dist_id,a.block_id,a.ps_id,a.po_id,a.gp_id,a.village_id,a.pin_no,a.sb_ac_no,a.direct_indirect_flag,a.pacs_id,a.economic_activity",
      table_name1 = "bdccb.md_group a LEFT JOIN public.md_branch b ON a.branch_code::text = b.branch_id::text LEFT JOIN bdccb.md_sahayika d ON a.sahayika_id::text = d.sahayika_id::text LEFT JOIN public.md_district e ON a.dist_id::text = e.dist_code::text LEFT JOIN public.md_block f ON a.block_id::text = f.block_id::text LEFT JOIN public.md_police_station g ON a.ps_id::text = g.ps_id::text LEFT JOIN public.md_postoffice h ON a.po_id::text = h.po_id::text LEFT JOIN public.md_gp i ON a.gp_id::text = i.gp_id::text LEFT JOIN public.md_village j ON a.village_id::text = j.vill_id::text",
...
groupRouter.post("/fetch_pacs_group_details", async (req, res) => {
  ...
  OR a.group_code::text ILIKE '%${data.group_name}%')`
    ...
    var select = "a.group_code,a.branch_code,b.branch_name,a.group_name,a.phone1,a.sahayika_id,d.sahayika_name,a.group_addr,a.dist_id,e.dist_name,a.block_id,f.block_name,a.ps_id,g.ps_name,a.po_id,h.post_name,a.gp_id,i.gp_name,a.village_id,j.vill_name,a.pin_no,a.open_close_flag,a.grp_open_dt,a.grp_close_dt,a.delete_flag,a.direct_indirect_flag,a.pacs_id,k.branch_name AS pacs_name",
      table_name = "bdccb.md_group a LEFT JOIN public.md_branch b ON a.branch_code::text = b.branch_id::text LEFT JOIN bdccb.md_sahayika d ON a.sahayika_id::text = d.sahayika_id::text LEFT JOIN public.md_district e ON a.dist_id::text = e.dist_code::text LEFT JOIN public.md_block f ON a.block_id::text = f.block_id::text LEFT JOIN public.md_police_station g ON a.ps_id::text = g.ps_id::text LEFT JOIN public.md_postoffice h ON a.po_id::text = h.po_id::text LEFT JOIN public.md_gp i ON a.gp_id::text = i.gp_id::text LEFT JOIN public.md_village j ON a.village_id::text = j.vill_id::text LEFT JOIN public.md_branch k ON a.pacs_id::text = k.branch_id::text",
