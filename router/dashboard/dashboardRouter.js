...
dashboardRouter.post("/fetch_member_outstanding_dtls", async (req, res) => {
  try{
   ...
   for (let loans of fetch_loan_dtls.msg) {
    ...
    mem_whr = `a.tenant_id = '${tenant_id}' AND a.ccb_loan_id = '${loans.loan_id}' AND a.group_code = '${group_code}' GROUP BY a.loan_id,a.group_code,c.group_name,a.member_code,d.member_name,a.prn_amt,a.intt_amt,b.trans_type`;
