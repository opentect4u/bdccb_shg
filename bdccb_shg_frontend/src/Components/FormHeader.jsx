...
function FormHeader({ text, mode = 0, data, title, bgClass = "bg-slate-800 dark:bg-slate-800" }) {
	return (
		<div className="bg-transparent dark:bg-gray-800 relative overflow-hidden mb-5">
			<div
				className={`flex flex-col ${bgClass} w-full md:flex-row items-center align-middle justify-start gap-3 space-x-2 px-8 rounded-full py-2`}
			>
				<Backbtn />
